 ...
 */
@Entity
@Table(name = "planificacion_tareas")
@XmlRootElement
@NamedQueries({
...
public class PlanificacionTareas implements Serializable {
    ...
    @Column(name = "idplanificacion", nullable = false)
    private Integer idplanificacion;
    @Basic(optional = false)
    @Column(name = "unidad", nullable = false, length = 50)
    private String unidad;
    @Basic(optional = false)
    @Column(name = "descripcionunidad", nullable = false, length = 200)
    private String descripcionunidad;
    @Basic(optional = false)
    @Column(name = "tarea", nullable = false, length = 50)
    private String tarea;
    @Basic(optional = false)
    @Column(name = "descripciontarea", nullable = false, length = 200)
    ...
    @JoinColumn(name = "claseid", referencedColumnName = "idcarrera", nullable = false)
    @ManyToOne(optional = false)
    ...
    public String toString() {
        return "uteq.sga.SYStemSGAv21.Models.PlanificacionTareas[ idplanificacion=" + idplanificacion + " ]";
    }
