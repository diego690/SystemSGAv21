...
public class Cuatrimestres implements Serializable {
    ...
    @Column(name = "idcuatrimestre", nullable = false)
    private Integer idcuatrimestre;
    @Basic(optional = false)
    @Column(name = "nombrecuatrimestre", nullable = false, length = 50)
    ...
    public String toString() {
        return "uteq.sga.SYStemSGAv21.Models.Cuatrimestres[ idcuatrimestre=" + idcuatrimestre + " ]";
    }
