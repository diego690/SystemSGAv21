...
public class Asignaciones implements Serializable {
    ...
    @JoinColumn(name = "aulaid", referencedColumnName = "aulaid", nullable = false)
    @ManyToOne(optional = false)
    private Aula aulaid;
    ...
    @JoinColumn(name = "seccionid", referencedColumnName = "seccionid", nullable = false)
    @ManyToOne(optional = false)
    ...
    public String toString() {
        return "uteq.sga.SYStemSGAv21.Models.Asignaciones[ idasignacion=" + idasignacion + " ]";
    }
