 ...
 */
@Entity
@Table(name = "matriculacion", uniqueConstraints = {
    @UniqueConstraint(columnNames = {"idestudiante"})})
@XmlRootElement
@NamedQueries({
...
public class Matriculacion implements Serializable {
    ...
    @Column(name = "idmatriculacion", nullable = false)
    private Integer idmatriculacion;
    @Column(name = "estadomatricula", length = 15)
    private String estadomatricula;
    @Column(name = "documentosrevisados", length = 2)
    ...
    @ManyToOne
    private Aula aula;
    @JoinColumn(name = "curso", referencedColumnName = "idcarrera", nullable = false)
    ...
    public String toString() {
        return "uteq.sga.SYStemSGAv21.Models.Matriculacion[ idmatriculacion=" + idmatriculacion + " ]";
    }
