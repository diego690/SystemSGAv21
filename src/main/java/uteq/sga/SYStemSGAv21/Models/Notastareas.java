...
public class Notastareas implements Serializable {
    ...
    @Column(name = "idnotastareas", nullable = false)
    private Integer idnotastareas;
    @Basic(optional = false)
    @Column(name = "nota", nullable = false)
    private double nota;
    @JoinColumn(name = "identregatareas", referencedColumnName = "identregatareas", nullable = false)
    ...
    public String toString() {
        return "uteq.sga.SYStemSGAv21.Models.Notastareas[ idnotastareas=" + idnotastareas + " ]";
    }
