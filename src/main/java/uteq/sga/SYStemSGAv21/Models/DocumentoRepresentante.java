 ...
 */
@Entity
@Table(name = "documento_representante")
@XmlRootElement
@NamedQueries({
...
public class DocumentoRepresentante implements Serializable {
    ...
    @Basic(optional = false)
    @Column(name = "descripciondocumento", nullable = false, length = 100)
    ...
    public String toString() {
        return "uteq.sga.SYStemSGAv21.Models.DocumentoRepresentante[ documentoid=" + documentoid + " ]";
    }
