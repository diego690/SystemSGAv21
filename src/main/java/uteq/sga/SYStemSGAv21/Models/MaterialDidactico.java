...
public class MaterialDidactico implements Serializable {
    ...
    @Column(name = "idmaterialdidactico", nullable = false)
    private Integer idmaterialdidactico;
    @Basic(optional = false)
    @Column(name = "descripcion", nullable = false, length = 200)
    private String descripcion;
    @Basic(optional = false)
    @Column(name = "archivo", nullable = false, length = 200)
    ...
    @JoinColumn(name = "idnumeroasignacion", referencedColumnName = "idnumeroasignacion", nullable = false)
    @ManyToOne(optional = false)
    ...
    public String toString() {
        return "uteq.sga.SYStemSGAv21.Models.MaterialDidactico[ idmaterialdidactico=" + idmaterialdidactico + " ]";
    }
